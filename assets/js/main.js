...
inter_btn.style.color = "#fff";
inter_btn.style.background = "none";
formi_tow.style.display = "none";
  ban_btn.style.color = "#fff";
  formi_one.style.display = "block";
ban_btn.style.background = "#fb5200";
...
inter_btn.addEventListener("click", ()=>{
  
inter_btn.style.color = "#fff";
inter_btn.style.background = "#fb5200";
  formi_tow.style.display = "block";
  formi_one.style.display = "none";
